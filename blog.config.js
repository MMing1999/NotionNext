...
const BLOG = {
  ...
  THEME_SWITCH: process.env.NEXT_PUBLIC_THEME_SWITCH || trur, // 是否显示切换主题按钮
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，我是华仔,欢迎来到我的博客🎉',
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '我在建造自己的小世界', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://xxxxxxxxxxxxx', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'minghua.work@gmail.com', // 邮箱地址 例如mail@tangly1024.com
